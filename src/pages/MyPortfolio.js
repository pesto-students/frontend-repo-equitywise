...
import DisplayBoard from '../components/SubMenu/DisplayBoard';
import { menuItems } from '../data/dataItems';

const MyPortfolio = () => {
  const [activeMenu, setActiveMenu] = useState(menuItems.MY_PORTFOLIO);
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto p-4">
        ...
        <SecondMenu activeMenu={activeMenu} setActiveMenu={setActiveMenu} />
        <DisplayBoard activeMenu={activeMenu} />
      </main>
      <Footer />
    </div>
  );
...
//        <h1 className="text-2xl font-bold mb-4">My Portfolio</h1>
//        <SecondMenu />
//        {/*<DisplayBoard portfolio={portfolio} />*/}
