...
// -----------------------------------------------------------------------------------------------
// Front End Code for getting quote using company symbol.
// const apiKey = "cpibh8hr01qpf0qhejg0cpibh8hr01qpf0qhejgg";
// const symbol = "ATGE";
...
// -----------------------------------------------------------------------------------------------
// Front End Code for getting live data of a company using its symbol
// Here front-end refers to the client side of the websockets. This code actually pertains to backend in our application.
// const WebSocket = require("ws");
// const socket = new WebSocket("wss://ws.finnhub.io?token=cpibh8hr01qpf0qhejg0cpibh8hr01qpf0qhejgg");

// // Connection opened -> Subscribe
// socket.addEventListener("open", function (event) {
//   socket.send(JSON.stringify({ type: "subscribe", symbol: "ATGE" }));
